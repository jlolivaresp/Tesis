...
a = residuos_t_test_F_test.FDR_FAR_fallas_tanque_residuos.groupby(level=['tipo_falla']).ttest_FDR.apply(lambda x: np.average(x))
b = residuos_t_test_F_test.FDR_FAR_fallas_tanque_residuos.groupby(level=['tipo_falla']).ttest_FAR.apply(lambda x: np.average(x))
c = residuos_t_test_F_test.FDR_FAR_fallas_tanque_residuos.groupby(level=['tipo_falla']).ftest_FDR.apply(lambda x: np.average(x))
d = residuos_t_test_F_test.FDR_FAR_fallas_tanque_residuos.groupby(level=['tipo_falla']).ftest_FAR.apply(lambda x: np.average(x))
...
FDR_FAR_fallas_tanque_copy = residuos_t_test_F_test.FDR_FAR_fallas_tanque_residuos.copy()
...
ej_deriva_pred = residuos_t_test_F_test.df_tanque_falla_residuos[(residuos_t_test_F_test.df_tanque_falla_residuos.tipo_falla == 'deriva')
                                                                 & (residuos_t_test_F_test.df_tanque_falla_residuos.caracteristica_1 == 0.02)
                                                                 & (residuos_t_test_F_test.df_tanque_falla_residuos.caracteristica_2 == 16.1)]
ej_pulso_pred = residuos_t_test_F_test.df_tanque_falla_residuos[(residuos_t_test_F_test.df_tanque_falla_residuos.tipo_falla == 'pulso')
                                                                & (residuos_t_test_F_test.df_tanque_falla_residuos.caracteristica_1 == 0.025)
                                                                & (residuos_t_test_F_test.df_tanque_falla_residuos.caracteristica_2 == 80)]
ej_varianza_pred = residuos_t_test_F_test.df_tanque_falla_residuos[(residuos_t_test_F_test.df_tanque_falla_residuos.tipo_falla == 'varianza')
                                                                   & (residuos_t_test_F_test.df_tanque_falla_residuos.caracteristica_1 == 0.025)
                                                                   & (residuos_t_test_F_test.df_tanque_falla_residuos.caracteristica_2 == 16.1)]
...
_, t_test_pred_drift, _, _ = f.fault_detector(ej_deriva_pred.nivel_armax).t_test(ej_deriva_pred.nivel_sin_falla,
