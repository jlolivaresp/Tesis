...
for i in delta_r:
    ...
    for k,kk in zip(delta_media,range(0,len(delta_media))):
        ...
        fign.suptitle('Deriva en la Resistencia Hidráulica (R) de la Válvula de Salida de 0.28 a {:.2e}\nDiferencia en '
                      'la Media a Detectar = {} con 95% de Confiabilidad'.format(0.28+i,k), size=14)
